...
Twilio workflows, weather-provider logic, queues, AWS deployment resources, registration, and frontend features are deferred to later phases. The current phone verification state is domain data only; no verification provider has been integrated.
